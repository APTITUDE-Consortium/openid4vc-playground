...
/**
 * @name ScaAttestationMetadataSchema
 ...
 */
export const ScaAttestationMetadataSchema = z.object({
  /**
      ...
      z.intersection(
        z.union([
          z.object({
            ...
            claims: z.array(
              z.object({
                /** The JSON path or key identifying the claim within the transaction payload. */
                claim_name: z.string(),
...
export type ScaAttestationMetadata = z.infer<typeof ScaAttestationMetadataSchema>
